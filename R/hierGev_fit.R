...
#' @return A list of the MLE estimates of the parameters and their corresponding standard errors.
#' @details 
...
#' @export
hierGev_fit <- function(y, x, theta, random, sp.thres=0){
