...
#' in the equal-tail credible interval given by the posterior draws, with the length of credible interval given by the i-th entry 
#' in `expected_covr`.
#' @export
check_draws_coverage <- function(y, draws, expected_covr=seq(0.1, 0.99, by = 0.01)){
