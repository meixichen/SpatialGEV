...
***SpatialGEV*** uses a Lebesgue prior
$$
\pi(\bm{B}, \TTh) \propto 1
$$
on the GP hyperparameters by default.  However, informative priors for these parameters can be specified as detailed below.
...
```{r sim2-plot-ab, fig.width=8, fig.height=4.5, out.width="100%"}
a <- simulatedData$a
