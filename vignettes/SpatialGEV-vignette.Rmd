...
## Installation
***SpatialGEV*** depends on the package [***TMB***](https://github.com/kaskr/adcomp) to perform the Laplace approximation. Make sure you have ***TMB*** installed following their [instruction]((https://github.com/kaskr/adcomp/wiki/Download)) before installing ***SpatialGEV***. Then run the following:
```{r eval=FALSE}
