...
s_vec <- exp(all_draws[, "s"])                   # extract posterior samples of s
for (i in 1:n_loc){
  a_vec <- all_draws[ , paste0("a", i)]          # extract posterior samples of a at location i
  b_vec <- exp(all_draws[ , paste0("log_b", i)]) # extract posterior samples of b at location i
